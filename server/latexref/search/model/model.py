...
def train_triplet(base, pos, neg, epochs=10, learning_rate=0.001):
	checkpoint_path = "./search/model/checkpoint/triplet.hdf5"
	h5_storage_path = "./search/model/h5/triplet.h5"
	hist_storage_path = "./search/model/history/triplet"
...
if __name__ == "__main__": 
	data = pd.read_csv('./search/model/data/sentence_root.csv')
	...
	Siamese_test = concept_encoder()
	# predictions = Siamese_test.predict(["Interpretability is not enough"])
	# print(predictions)
